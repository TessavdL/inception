...
#docker run -it --rm --name wpc --env="WORDPRESS_DB_HOST=localhost" --env="WORDPRESS_DB_NAME=wordpress_db" --env="WORDPRESS_DB_USER=superuser" --env="WORDPRESS_DB_PASSWORD=coffee" --env="WORDPRESS_DB_TABLE_PREFIX=wp_" wp bash
